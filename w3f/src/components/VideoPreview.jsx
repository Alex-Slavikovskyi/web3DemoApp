  ...
  return (
    ...
    >
      ...
      <Box sx={{ paddingTop: '6px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
        <Typography sx={{ fontWeight: 600, fontSize: '13px', lineHeight: '16px', color: '#55E5C5' }}>{preview.title}</Typography>
        <Typography sx={{ fontWeight: 500, fontSize: '15px', lineHeight: '20px', color: '#FFF' }}>{preview.subTitle}</Typography>
        <Box
          sx={{
            paddingTop: '4px',
            display: 'flex',
